...
public class Notes_senior extends AppCompatActivity {
    private static final int PICK_IMAGE_REQUEST=1;
    private Button mButtonUpload;
    private EditText mEditTextTopicname,mEditTextSubjectname,mEditTextDetails,mEditTextNO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes_senior);
        mButtonUpload=findViewById(R.id.button);

        mEditTextTopicname=findViewById(R.id.editText5);
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Notes_senior.this,"Upload in Progress",Toast.LENGTH_SHORT).show();
                }else {
